...
namespace TaxCalculator {
    ...
    public partial class CitizenDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CitizenDataTable : global::System.Data.TypedTableBase<CitizenRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CitizenRow AddCitizenRow(string FirstName, string LastName, string Zone, string District, string StreetName, int Wardno, string Municipality) {
        ...
        public partial class CitizenRow : global::System.Data.DataRow {
            ...
            public string Zone {
                get {
                    try {
                        return ((string)(this[this.tableCitizen.ZoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Zone\' in table \'Citizen\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCitizen.ZoneColumn] = value;
                }
            }
            ...
            public bool IsZoneNull() {
                return this.IsNull(this.tableCitizen.ZoneColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetZoneNull() {
                this[this.tableCitizen.ZoneColumn] = global::System.Convert.DBNull;
            }
...
namespace TaxCalculator.CitizenDBDataSetTableAdapters {
    ...
    public partial class CitizenTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Citizen] ([FirstName], [LastName], [Zone], [District], [Street" +
                "Name], [Wardno], [Municipality]) VALUES (@FirstName, @LastName, @Zone, @District" +
                ", @StreetName, @Wardno, @Municipality)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Citizen] SET [FirstName] = @FirstName, [LastName] = @LastName, [Zon" +
                "e] = @Zone, [District] = @District, [StreetName] = @StreetName, [Wardno] = @Ward" +
                "no, [Municipality] = @Municipality WHERE (([CitizenId] = @Original_CitizenId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CitizenId, FirstName, LastName, Zone, District, StreetName, Wardno, Munici" +
                "pality FROM dbo.Citizen";
        ...
        public virtual int Fill(CitizenDBDataSet.CitizenDataTable dataTable) {
        ...
        public virtual CitizenDBDataSet.CitizenDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CitizenDBDataSet.CitizenDataTable dataTable = new CitizenDBDataSet.CitizenDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CitizenDBDataSet.CitizenDataTable dataTable) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Zone, string District, string StreetName, int Wardno, string Municipality) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Zone, string District, string StreetName, int Wardno, string Municipality, int Original_CitizenId) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_CitizenId));
